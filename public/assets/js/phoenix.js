;(function (global, factory) {
            ...
            o.forEach(o => {
                ...
                if (t) {
                    ...
                    o.center &&
                        ...
                        n &&
                            a &&
                            (n.addEventListener('click', () => l.zoomIn()),
                            a.addEventListener('click', () => l.zoomOut())),
                        c &&
                            c.addEventListener('click', () =>
                                l.getContainer().requestFullscreen()
                            )
                }
            })
    }
    ...
    const wizardInit = () => {
        const { getData: e } = window.phoenix.utils,
            ...
            a = '[data-wizard-step]',
            r = '[data-wizard-form]',
            d = '[data-wizard-password]',
            s = '[data-wizard-confirm-password]',
            o = '[data-wizard-next-btn]',
            l = '[data-wizard-prev-btn]',
                    ...
                    w.forEach((t, a) => {
                        t.addEventListener(c, a => {
                            ...
                            t.addEventListener(u, () => {
                                ...
                                for (let e = 0; e < E; e += 1)
                                    w[e].classList.add('done'),
                                        e > 0 &&
                                            w[e - 1].classList.add('complete')
                                for (let e = E; e < w.length; e += 1)
                                    w[e].classList.remove('done'),
                                        e > 0 &&
                                            w[e - 1].classList.remove(
                                                'complete'
                                            )
                                E > w.length - 2
        ...
        e &&
            e.forEach(e => {
                const t = e.querySelector('[data-price-toggle]'),
                    ...
                    a = new window.bootstrap.Collapse(c, { toggle: !1 })
                t.addEventListener('change', t => {
                    ;(r[0].checked = !0),
                        t.target.checked
                            ? e.classList.add('active')
                            : (e.classList.remove('active'), a.hide())
                }),
                    r.forEach(e => {
    ...
    const nouisliderInit = () => {
        const { getData: i } = window.phoenix.utils

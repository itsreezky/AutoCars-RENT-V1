...
<div class="offcanvas offcanvas-end settings-panel border-0" id="settings-offcanvas" tabindex="-1"
    ...
    <div class="offcanvas-header align-items-start border-bottom flex-column border-translucent">
        <div class="pt-1 w-100 mb-6 d-flex justify-content-between align-items-start">
            <center>
            <div>
                <img src="{{asset ('assets/img/reezky/ReezkyLogoNoBG.png') }}" class="d-dark-none" alt="reezky" width="350">
                <img src="{{asset ('assets/img/reezky/ReezkyLogoNoBGWhite.png') }}" class="d-light-none" alt="reezky" width="350">
                <h5 class="mt-4 mb-2 ms-2 lh-sm"><span class="fas fa-palette me-2 fs-8"></span>
                    Theme Customizer</h5>
        ...
        <button class="btn btn-phoenix-secondary w-100" data-theme-control="reset"><span
                ...
                <button class="btn btn-phoenix-secondary w-100" type="button" data-bs-dismiss="offcanvas" aria-label="Close"><span
                    class="fas fa-times me-2 fs-10"></span>Close Costumize</button>
    </div>
            ...
            <div class="row gx-2">
                ...
                <div class="col-4"><input class="btn-check" id="themeSwitcherAuto" name="theme-color" type="radio"
                        ...
                        class="btn d-inline-block btn-navbar-style fs-9" for="themeSwitcherAuto"> <span
                            class="mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0"
                                src="{{asset ('assets/img/generic/auto.png') }}" alt="" /></span><span class="label-text">
                            Auto</span></label></div>
            </div>
        </div>
            ...
            <div class="settings-popover"><span class="ripple"><span
                        class="fa-spin position-absolute all-0 d-flex flex-center"><span
                            class="icon-spin position-absolute all-0 d-flex flex-center"><svg width="20" height="20"
                                viewBox="0 0 20 20" fill="#ffffff" xmlns="../../../../../../www.w3.org/2000/svg.html">
                                <path

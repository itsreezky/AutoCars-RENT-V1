                ...
                <div class="card bg-gray-200 shadow border-0 mb-0">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-dark shadow-dark border-radius-lg py-3 pe-1 text-center py-4">
                            ...
                            <p class="mb-1 text-sm text-white">Please Edit Your Profil Data Carefully</p>
                        </div>
                    </div>
                    <div class="card-body">

                        <form method="POST" action="{{ route('own.update', ['id' => $owner->id])  }}"
                            ...
                            <div class="input-group input-group-static mb-4">
                                <label>No.HP</label>
                                <input id="hp" type="number" class="form-control" value="{{ $owner->hp }}" name="hp">
                            </div>
                            <div class="input-group input-group-static mb-4">
                                <label>Alamat</label>
                                <input id="alamat_garasi" type="text" class="form-control" value="{{ $owner->alamat_garasi }}"
                                    name="alamat_garasi">
                            </div>

                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="/garage/{{ $car->id }}"
                            ...
                            <div class="input-group input-group-static mb-4">
                                <label>Merk</label>
                                <input id="merk" type="text" class="form-control" value="{{ old('merk', $car->merk) }}"
                                    name="merk">
                            </div>
                            <div class="input-group input-group-static mb-4">
                                <label>Model</label>
                                <input id="model" type="text" class="form-control" value="{{ old('merk', $car->model) }}"
                                    name="model">
                            </div>
                            <div class="input-group input-group-static mb-4">
                                <label>Plat</label>
                                <input id="plat" type="text" class="form-control" value="{{ old('merk', $car->plat) }}"
                                    name="plat">
                            </div>
                            <div class="input-group input-group-static mb-4">
                                <label>Tarif</label>

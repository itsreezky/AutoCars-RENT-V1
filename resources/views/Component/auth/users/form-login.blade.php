                        ...
                        <div class="col mx-auto">
                            <div class="auth-form-box">
                                ...
                                <div class="position-relative">
                                    ...
                                    <div class="divider-content-center bg-body-emphasis">Login form</div>
                                </div>

                                {{-- Login Form --}}
                                <form action="{{ route('auth.authenticate') }}" method="POST" role="form"
                                    class="text-start">
                                    ...
                                    <div class="row flex-between-center mb-7">
                                        ...
                                        class="btn btn-primary w-100 mb-3">Sign In</button>

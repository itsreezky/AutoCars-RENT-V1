                                    ...
                                    <li class="d-flex align-items-center mt-5">
                                        <span class="badge badge-phoenix badge-phoenix-primary">
                                            <a href="{{route('market')}}"><span
                                                    ...
                                                    class="text-body-tertiary fw-bold">BACK TO
                                                    MARKET</span></a></span>
                                    </li>
                                </ul>
                        ...
                        <div class="col mx-auto">
                            <div class="auth-form-box">
                                <div class="text-center mt-5">
                                    ...
                                    <h3 class="text-body-highlight">Register Owner Cars Partner</h3>
                                    <p class="text-body-tertiary">Input and Validation Data</p>
                                    @if ($errors->any())
                                ...
                                <div class="card theme-wizard mb-5" data-theme-wizard="data-theme-wizard">
                                    ...
                                    {{-- Verify Form --}}
                                    <form action="{{route('ownstore')}}" method="POST"
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane active" role="tabpanel"
                                                    ...
                                                    <div class="mb-2"><input class="form-control" type="hidden"
                                                            name="status" placeholder="PENDING"
                                                            required="required" value="PENDING" id="status"
                                                            readonly>
                                                    </div>
                                                    ...
                                                    <div class="mb-5"><label class="form-label"
                                                            for="bootstrap-wizard-validation-wizard-email">Password</label><input
                                                            class="form-control" type="password" name="password"
                                                            required="required" id="password"
                                                            placeholder="Input your password">
                                                        <div class="invalid-feedback">You must add password
                                                        </div>
                                                    </div>
                                                    <div class="mb-5"><label class="form-label"
                                                            for="bootstrap-wizard-validation-wizard-email">Confirm
                                                            Password</label><input class="form-control"
                                                            type="password" name="confirm-password"
                                                            required="required" id="confirm-password"
                                                            placeholder="Input your password again">
                                                        <div class="invalid-feedback">Password doesnt match
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="tab-pane" role="tabpanel"
                                                    ...
                                                    <div class="mb-2"><label class="form-label"
                                                        ...
                                                        <div class="mb-2"><label class="form-label"
                                                                for="bootstrap-wizard-validation-wizard-address">Garage
                                                                Address</label><textarea class="form-control"
                                                                rows="4" value="{{ old('alamat_garasi') }}"
                                                                id="alamat_garasi" name="alamat_garasi"
                                                                required="required"
                                                                placeholder="Alamat Garasi"></textarea>
                                                            <div class="invalid-feedback">This field is
                                                                required.
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-12 col-sm-auto">
                                                            <div class="text-center text-sm-start">
                                                                ...
                                                                <p class="text-body-emphasis fs-9">Click
                                                                    Validation and wait admin to check your
                                                                    account</p>

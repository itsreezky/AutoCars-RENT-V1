<section>
    <div class="container">
        ...
        <div class="bg-holder d-none d-xl-block bg-left"
            style="background-image:url(../../assets/img/bg/bg-left-27.png);background-size:auto;"></div>

        <div class="bg-holder d-none d-xl-block bg-right"
            style="background-image:url(../../assets/img/bg/bg-right-27.png);background-size:auto;"></div>

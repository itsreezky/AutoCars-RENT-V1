...
@endif
                                        ...
                                        <div class="card theme-wizard mb-5" data-theme-wizard="data-theme-wizard">
                                            ...
                                            {{--  Verify Form --}}
                                            <form action="{{ route('verified.verify', ['id' => $user->id])  }}" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <div class="tab-pane active" role="tabpanel"
                                                            ...
                                                            <div class="mb-2">
                                                                <label class="form-label text-body"
                                                                    for="bootstrap-wizard-validation-wizard-name">UUID</label><input
                                                                    class="form-control" type="text" name="uuid"
                                                                    placeholder="e.g Reezky" required="required"
                                                                    value="{{ $user->uuid }}" id="uuid" readonly>
                                                            ...
                                                            <div class="mb-2">
                                                                <label class="form-label text-body"
                                                                    for="bootstrap-wizard-validation-wizard-name">Status Upgrade</label><input
                                                                    class="form-control" type="text" name="status"
                                                                    placeholder="e.g Reezky" required="required"
                                                                    value="Verified Member" id="status" readonly>
                                                                <div class="invalid-feedback">Please input full name.
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="tab-pane" role="tabpanel"
                                                            ...
                                                            <div class="row gx-3 gy-2">
                                                                <div class="col-12"><label class="form-label"
                                                                        for="bootstrap-wizard-validation-card-holder-country">Foto KTP</label>
                                                                        <input class="form-control" id="foto_ktp" name="foto_ktp" type="file" />
                                                                    <div class="invalid-feedback">This field is
                                                                        required.</div>
                                                                </div>
